...
#[init(contract = "ranking_dapp", event = "Cis2Event<ContractTokenId, ContractTokenAmount>")]
...
/// testing.
#[receive(contract = "ranking_dapp", name = "view", return_value = "ViewState")]
